<?php
  ...
  // Required
  head([
    'title' =>'ISIS Tamil Keyboard for Keyman',
...
?>
<h1 class="red underline large">ISIS Tamil Keyboard for Keyman</h1>
<p>
...
<div id="download-cta" data-language='ta' data-keyboard='isis_tamil'>
  ...
  <div class="download-cta-big Windows" id="cta-big-Windows">
    <h3>Tamil (ISIS) for Keyman for Windows</h3>
    <p>
