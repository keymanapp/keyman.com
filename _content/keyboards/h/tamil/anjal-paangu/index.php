<?php
  ...
  // Required
  head([
    'title' =>'Anjal Paangu Tamil Keyboard for Keyman',
...
?>
<h1 class="red underline large">Anjal Paangu Tamil Keyboard for Keyman</h1>
<p>
...
<div id="download-cta" data-language='ta' data-keyboard='thamizha_anjal_paangu'>
  ...
  <div class="download-cta-big Windows" id="cta-big-Windows">
    <h3>Tamil Anjal Paangu for Keyman for Windows</h3>
    <p>
  ...
  <div class="download-cta-big" id="cta-big-Web">
    <h3>Type Tamil Anjal Paangu in your Browser</h3>
    <p>
...
<div id='info'>
  ...
  <p>
    Get help on this keyboard with the <a href='<?= KeymanHosts::Instance()->help_keyman_com ?>/keyboard/ekwunitamil'>Tamil Anjal Paangu Keyboard Documentation</a>.
  </p>
</div>
<br/>
