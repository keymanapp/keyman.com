...
<p><a href='<?= KeymanHosts::Instance()->blog_keyman_com ?>/2017/08/keyman-is-now-free-and-open-source/'>Read the full announcement on our blog</a>!</p>
...
<dl>
  ...
  <dd>
    ...
    <p>You can also donate directly to the Keyman project through the Keyman website at&nbsp;<a href="<?= KeymanHosts::Instance()->keyman_com ?>/donate"><?= KeymanHosts::Instance()->keyman_com_host ?>/donate</a>.</p>
  </dd>
</dl>
