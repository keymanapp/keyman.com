...
<ul>
    ...
    <li><a href="<?= KeymanHosts::Instance()->downloads_keyman_com ?>/windows/stable/<?= $ver_windows_14 ?>/keymandesktop-<?= $ver_windows_14 ?>.exe">Keyman Desktop <?= $ver_windows_14 ?> Download</a> (No activation required)</li>
