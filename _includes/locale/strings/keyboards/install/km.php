...
return [
  ...
  "help_on_installing_keyboard" => "ជំនួយក្នុងការដំឡើងក្ដារចុច",

  # Help on installing Keyman
  "help_on_installing_keyman" => "ជំនួយក្នុងការដំឡើង Keyman",

  # Download keyboard
  "download_keyboard" => "ទាញយកក្ដារចុច",

  # Download just this keyboard...
  "download_just_keyboard" => "ទាញយកតែក្ដារចុចនេះ",

  # ... and then install in the app
  "and_then_install_in_the_app" => "បន្ទាប់មកដំឡើងនៅក្នុងកម្មវិធី។",
