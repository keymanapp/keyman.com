...
return [
  ...
  # Page Description
  "page_description" => "Keyman Keyboard Search",

  # Keyboard search bar
  "keyboard_search" => "Keyboard search:",
  
  # Search bar placeholder
  "enter_language" => "Enter language or keyboard",
  ...
  "enter_name" => "Enter the name of a keyboard or language to search for",
  
  # Search box link for popular keyboards
  "popular_keyboards" => "Popular keyboards",
  
  # Search box link for all Keyman keyboards
  "all_keyboards" => "All keyboards",
