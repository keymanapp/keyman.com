"use strict";
var blc            = require("./node_modules/broken-link-checker/lib/index");

var chalk = require("chalk");
var humanizeDuration = require("humanize-duration");
var nopter = require("nopter");
var defaultOptions = require("./node_modules/broken-link-checker/lib/internal/defaultOptions");
var pkg = require("./node_modules/broken-link-checker/package.json");
...
function logResult(result, finalResult)
{
	...
	{
    var url = result.url.resolved != null ? chalk.yellow( result.url.resolved ) : chalk.yellow( result.url.original );

    if(result.http.cached) return output;
