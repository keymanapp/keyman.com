...
<div id="download-cta" data-language='ta' data-keyboard='vm_tamil_modular'>
  ...
  <div class="download-cta-big" id="cta-big-Web">
    <h3>Type Visual Media (Modular) in your Browser</h3>
    <p>
...
<div id='info'>
  ...
  <p>
    Get help on this keyboard with the <a href='<?= KeymanHosts::Instance()->help_keyman_com ?>/keyboard/visual_media_tamil_modular'>Visual Media (Modular) Keyboard Documentation</a>.
  </p>
</div>
<br/>
