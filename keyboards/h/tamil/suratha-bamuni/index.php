...
<div id="download-cta" data-language='ta' data-keyboard='ekwbamuni'>
  ...
  <div class="download-cta-big Windows" id="cta-big-Windows">
    <h3>Tamil Suratha Bamuni for Keyman for Windows</h3>
    <p>
  ...
  <div class="download-cta-big" id="cta-big-Web">
    <h3>Type Tamil Suratha Bamuni in your Browser</h3>
    <p>
...
<div id='info'>
  ...
  <p>
    Get help on this keyboard with the <a href='<?= KeymanHosts::Instance()->help_keyman_com ?>/keyboard/ekwbamuni'>Tamil Suratha Bamuni Keyboard Documentation</a>.
  </p>
