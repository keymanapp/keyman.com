...
<h2 class="red underline">About SIL International</h2>
...
<h2 style='clear:left' class="red underline">About National Polytechnic Institute of Cambodia</h2>
...
<h2 class="red underline">Current Developers</h2>

<p class="center"><img class="inline" src="<?php echo cdn("img/marc.png"); ?>" /><br/><br/></p>
<h4 class="caption">Marc Durdin</h4>
<br/>
...
<h4 class="caption">Makara Sok</h4>
<br/>
...
<p style="margin-top: 32px;" class="center"><img class="inline" src="<?php echo cdn("img/joshua.jpg"); ?>" /><br/><br/></p>
<h4 class="caption">Joshua Horton</h4>
<br/>
...
<p style="margin-top: 32px;" class="center"><img class="inline" src="<?php echo cdn("img/tombogle.jpg"); ?>" /><br/><br/></p>
<h4 class="caption">Tom Bogle</h4>
<br/>
...
<p>
  ...
  <a href='https://www.cloudflare.com/'>Cloudflare</a> speeds up and protects millions of websites, including ours.
  ...
  <br />
  <img style="width: 40%; margin-top: 20px" src="<?php echo cdn("img/browserstack.svg"); ?>" />
  <br />
  We are now using <a href='https://www.browserstack.com/'>BrowserStack</a> to test KeymanWeb and browser and renderer
