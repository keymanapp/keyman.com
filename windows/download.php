...
<div class="download-stable" id="vista">
    <p>Keyman for Windows <?php echo $stable_version; ?> is not compatible with Windows Vista. Please download Keyman Desktop 8.0 instead from our <a href="/downloads/archive/">archived downloads page</a>.</p>
</div>
<div class="download-stable" id="xp">
    <p>Keyman for Windows <?php echo $stable_version; ?> is not compatible with Windows XP. Please download Keyman Desktop 8.0 instead from our <a href="/downloads/archive/">archived downloads page</a>.</p>
</div>

<h2 class="red underline">Download Keyman for Windows <?php echo $stable_version; ?> - completely free</h2>
<p>
...
<p>
    Keyman for Windows <?php echo $stable_version; ?> is compatible with Windows 7, Windows 8, Windows 8.1 and Windows 10. If you have an older version of Windows, please download Keyman Desktop 8.0 from our <a href="/downloads/archive/">archived downloads page</a>.
</p>
<div class="download-stable" id="download-with-language">
    <h3>Keyman for Windows <?php echo $stable_version; ?> for your language</h3>
...
<h2 class="red underline">Download Keyman for Windows <?php echo $stable_version; ?> without any keyboards</h2>
<p>
